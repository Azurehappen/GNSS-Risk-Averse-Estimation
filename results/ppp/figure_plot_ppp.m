...
raps_hor_err = output_raps.hor_err;
raps_ver_err = abs(output_raps.ned_err(3,:));
raps_cost = output_raps.cost;
td_hor_err = output_td.hor_err;
td_ver_err = abs(output_td.ned_err(3,:));
td_cost = output_td.cost;
ekf_hor_err = output_ekf.hor_err;
ekf_ver_err = abs(output_ekf.ned_err(3,:));
ekf_cost = output_ekf.cost;
